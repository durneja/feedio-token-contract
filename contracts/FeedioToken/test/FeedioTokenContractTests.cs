...
namespace FeedioTokenTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class FeedioTokenContractTests : IClassFixture<CheckpointFixture<FeedioTokenContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public FeedioTokenContractTests(CheckpointFixture<FeedioTokenContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("FeedioTokenTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<FeedioTokenContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<FeedioTokenContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<FeedioTokenContract>();
            var contractStorage = storages.StorageMap("FeedioTokenContract");
